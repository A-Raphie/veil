...
/**
 * WrongNetworkBanner — a prominent, dismissible banner with one-click switch.
 * Shown when the connected wallet is on a chain this app doesn't support.
 * Offers switching to either Sepolia or Ethereum Mainnet.
 */
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span>You&apos;re on an unsupported network. Switch to use Veil.</span>
      </div>
      <div className="flex items-center gap-2">
        <button
